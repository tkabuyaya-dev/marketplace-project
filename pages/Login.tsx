  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 pt-16">
      <div className="w-full max-w-sm text-center space-y-8">
        <div>
          <h1 className="text-4xl font-black bg-gradient-to-r from-blue-400 to-rose-400 text-transparent bg-clip-text mb-2">AuraBuja</h1>
          <p className="text-gray-400">Connectez-vous pour accéder à l'expérience complète.</p>
        </div>
