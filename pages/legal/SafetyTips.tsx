    ...
    <div className="max-w-2xl mx-auto">
      ...
      <LegalSection title="Avant d'acheter — vérifier le vendeur">
        <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <li>Privilégiez les vendeurs avec une <strong className="text-ink">boutique active</strong> depuis plusieurs semaines.</li>
      ...
      <LegalSection title="Paiement Mobile Money — bonnes pratiques">
        <ul className="list-disc list-inside space-y-2 ml-2">
          ...
          <li>Pour les montants importants, privilégiez le <strong className="text-ink">paiement à la livraison</strong> ou un rendez-vous physique.</li>
      ...
      <LegalSection title="Signes d'une possible arnaque">
        <ul className="list-disc list-inside space-y-2 ml-2">
          <li>Le prix est <strong className="text-ink">anormalement bas</strong> par rapport au marché.</li>
          <li>Le vendeur insiste pour un <strong className="text-ink">paiement immédiat</strong> sans laisser le temps de réfléchir.</li>
          ...
          <li>Le compte est <strong className="text-ink">tout récent</strong> et n'a aucun avis.</li>
      ...
      <LegalSection title="Signaler un problème">
        ...
        <ul className="list-disc list-inside space-y-2 ml-2">
          <li>Email : <a href={`mailto:${NUNULIA_WHATSAPP.email}`} className="text-goldText hover:underline">{NUNULIA_WHATSAPP.email}</a></li>
          <li>WhatsApp : <a href={buildWaUrl('🚨 Signalement NUNULIA\nType (arnaque / fraude / suspect) :\nDescription :')} target="_blank" rel="noopener noreferrer" className="text-goldText hover:underline">{NUNULIA_WHATSAPP.e164}</a></li>
        </ul>
