      ...
      <div className="pb-24 pt-safe-header md:pt-24 px-4 max-w-7xl mx-auto">
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
          ...
          <button
            ...
            className={`px-6 py-3 ${tc.bg400} text-white rounded-full font-medium hover:opacity-90 transition-opacity`}
          >
    ...
    <div className="pb-24 pt-safe-header md:pt-24 px-4 max-w-7xl mx-auto">
      ...
      {loading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[1, 2, 3, 4].map((n) => (
            <div key={n} className="bg-gray-800 rounded-2xl h-80 animate-pulse" />
          ))}
        </div>
      ) : products.length === 0 ? (
        /* Empty state */
