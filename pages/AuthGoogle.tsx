  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] dark:bg-gray-950 flex flex-col items-center justify-center px-6">
      ...
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-black text-gray-900 dark:text-white">NUNULIA</h1>
      </div>

      <div className="w-full max-w-sm bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 shadow-xl dark:shadow-2xl">
        ...
        {status === 'idle' && (
          <>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-500 text-center mb-8">
            ...
            <div className="mt-6 p-3 bg-amber-50 border border-amber-200 dark:bg-amber-500/10 dark:border-amber-500/20 rounded-xl">
              <p className="text-xs text-amber-800 dark:text-amber-400/90 text-center leading-relaxed">
        ...
        {status === 'error' && (
          <div className="text-center py-2">
            ...
            <p className="text-sm text-red-700 dark:text-red-400 mb-6 bg-red-50 dark:bg-red-400/10 border border-red-200 dark:border-red-400/20 rounded-xl px-3 py-2">
              {errorMsg}
            </p>
            <button
              onClick={() => setStatus('idle')}
              className="w-full py-3 bg-gray-100 hover:bg-gray-200 text-gray-900 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white font-bold rounded-xl text-sm transition-colors"
            >
      ...
      <button
        onClick={() => navigate('/')}
        className="mt-6 text-sm text-gray-600 hover:text-gray-700 dark:text-gray-500 dark:hover:text-gray-400 transition-colors"
      >
