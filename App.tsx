...
const App: React.FC = () => {
  ...
  const hideNavbar = ['/login', '/auth-google', '/register-seller', '/devenir-vendeur', '/dashboard', '/admin', '/cgu', '/politique-confidentialite', '/securite', '/search', '/favorites', '/demandes'].includes(location.pathname)
